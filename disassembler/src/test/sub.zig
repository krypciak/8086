...
test "sub" {
    ...
    try testing.assertInstructionDisassembly("sub bx, [bp + 0]");
    ...
    try testing.assertInstructionDisassembly("sub [bp + 0], bx");
    ...
    try testing.assertInstructionDisassembly("sub byte [bx], 34");
    try testing.assertInstructionDisassembly("sub word [bx + di], 29");
    ...
    try testing.assertInstructionDisassembly("sub al, -30");
