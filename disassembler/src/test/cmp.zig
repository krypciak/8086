...
test "cmp" {
    ...
    try testing.assertInstructionDisassembly("cmp bx, [bp + 0]");
    ...
    try testing.assertInstructionDisassembly("cmp [bp + 0], bx");
    ...
    try testing.assertInstructionDisassembly("cmp byte [bx], 34");
    try testing.assertInstructionDisassembly("cmp word [4834], 29");
    ...
    try testing.assertInstructionDisassembly("cmp al, -30");
